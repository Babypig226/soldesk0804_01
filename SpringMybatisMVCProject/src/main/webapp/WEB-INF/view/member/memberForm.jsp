...
<table width = '600' align = 'center' border = '1' >
	...
	<tr>
		...
		<td ><form:input path='userId' id='userId' class='userId' size='15' maxlength='10' autofocus="autofocus"/><form:errors path = "userId"/></td>
	</tr>
	<tr>
		<th ><label for='userPw'>비밀번호</label></th>
		<td ><form:password path = 'userPw' id='userPw'	size='15' maxlength='12'/><form:errors path = "userPw"/></td>
	</tr>
	<tr>
		<th><label for='userPwCon'>비밀번호확인</label></th>
		<td><form:password path='userPwCon' id='userPwCon' size='15' maxlength='12'/><form:errors path = "userPwCon"/></td>
	</tr>
	<tr>
	...
	<tr>
 	...
 	<tr>
		...
		<td><input type='text' name='userBirth' id='userBirth' 	placeholder='1999-12-12' value = "${memberCommand.userBirth}"><form:errors path = "userBirth"/>
		${err }
		</td>
	</tr>
 	<tr>
		...
		<form:radiobutton path='userGender' id='userGender' value='F' />여자 </td>
	</tr>
	<tr>
 	...
 	<tr>
		...
		<td><form:input path='userEmail' id='userEmail' value = "${memberCommand.userEmail }"/><form:errors path = "userEmail"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><form:input path='userPh1' id ='userPh1' placeholder='123-123-1234 ,123-1234-1234' size= '26' maxlength='13' /><form:errors path = "userPh1"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<form:checkbox value="Javascript" path="interest" />Javascript
		</td>
	</tr>
	</tbody>
</table>
