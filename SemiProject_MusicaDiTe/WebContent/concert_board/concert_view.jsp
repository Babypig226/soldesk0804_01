...
<form action="concertWriteIntensive.cct" method="post" name="cctContentform" enctype = 'multipart/form-data'>
 <div class="boardloc">
      <table class="table table-hover" style="width: 800px">
		...
		<tr><td colspan=9 align="center"><b>공연정보상세보기</b></td></tr>
	<tr>
		<td rowspan = "5" colspan=5><img src = "../concert_board/upload/${dto.strPoster}"></td>
	...
	<tr>
		<td colspan = "5"style="font-family:돋음; font-size:12" height="16">
			<c:if test = "${dto.tktVal == 1}"><input type = "button" value = "예매하기" id = 'book' class="btn"></c:if>
		</td>
	</tr>
	<tr>
		<td style="font-family:돋음; font-size:12" height="16">
	...
	<tr>
		<td >상세이미지</td>
		<td colspan=8><img src = "../concert_board/upload/${dto.strDetail}"></td>
	</tr>
	<tr>
