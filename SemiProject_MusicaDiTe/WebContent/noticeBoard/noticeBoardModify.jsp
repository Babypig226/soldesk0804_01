...
<body>
	...
	<form action="noticeBoardModifyPro.not" method="post" name="modifyform">

		<div class="boardloc">
			<table class="table " style="width: 600px">
				<input type="hidden" name="num" value="${list[0].noticeNum}" />
				...
				<tr>
					...
					<td><input name="noticeSubject" size="50" maxlength="100"
						value="${list[0].noticeSubject }"></td>
				</tr>
				<tr>
					<td style="font-family: 돋음; font-size: 12">
						<div align="center">내 용</div>
					</td>
					<td><textarea name="noticeContent" cols="67" rows="15">${list[0].noticeContent }</textarea>
					</td>
				</tr>
