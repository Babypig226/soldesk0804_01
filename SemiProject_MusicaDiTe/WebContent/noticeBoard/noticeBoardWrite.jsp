...
<body>
	...
	<form action="notBoardWrite.not" method="post" name="boardform">
		...
		<div class="boardloc">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><input name="noticeName" type="text" size="10"
				...
				<tr>
					...
					<td><input name="noticeSubject" type="text" size="50"
				...
				<tr>
					...
					<td><textarea name="noticeContent" cols="67" rows="15"></textarea>
					</td>
				</tr>
